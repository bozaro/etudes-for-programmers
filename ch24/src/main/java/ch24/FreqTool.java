...
/**
 * Генерация данных для поиска ключевого слова.
 *
 * @author Artem V. Navrotskiy
 */
public class FreqTool {
    private static final Logger log = Logger.getLogger(FreqTool.class.getName());
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            System.err.println("Usage: " + FreqTool.class.getName() + parser.printExample(ExampleMode.ALL));
        ...
        try (InputStream stream = FreqTool.class.getResourceAsStream("/ch24/alphabet_ru.txt")) {
