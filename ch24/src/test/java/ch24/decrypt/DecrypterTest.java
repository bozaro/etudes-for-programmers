...
public class DecrypterTest {
    ...
    public void testKeywordLength() throws IOException {
        Alphabet alphabet = Alphabet.load(getClass().getResourceAsStream("/ch24/alphabet_ru.txt"));
        String key = "АЛЬФА";
    ...
    public void testKeywordDictionary() throws IOException {
        ...
        String key = "АЛЬФА";
        String crypto = Vigenere.encrypt(alphabet.getAlphabet(), CRYPT, key, TEXT);
        Assert.assertEquals(key, Decrypter.findKeywordDictionary(alphabet, crypto, key.length(), getClass().getResourceAsStream("/ch24/dict_ru.txt")));
    }
